...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } else if (!ctype_alpha(str_replace(" ","", $nama))) {
    ...
    if (empty($email)) {
        ...
        $emailErr = "Format email tidak validf";
    }
    ...
    } else if (!ctype_alpha(str_replace(" ","", $jurusan))) {
    ...
    if (empty($fakultas)) {
        $fakultasErr = "Nama wajib diisi";
    } else if (!ctype_alpha(str_replace(" ","", $fakultas))) {
